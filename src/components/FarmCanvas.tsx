...
import { IsoFlyingBees } from './isometric/IsoFlyingBees';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Isolated high-performance flying worker bees layer */}
        <IsoFlyingBees
          entities={entities}
          gridToIso={gridToIso}
          maxBees={maxBees}
          onHarvestNectarFromBush={onHarvestNectarFromBush}
          onAddNectarToTree={onAddNectarToTree}
        />
